...
<body class="ls-ty-body">
    ...
    @php
        ...
        $trackingCode =
            $listing->tracking_id ?? (request('tracking') ?? 'TRK-' . strtoupper(substr(md5((string) now()), 0, 10)));
                    ...
                    <div class="ls-ty-header">
                        <div class="ls-ty-icon-wrap">
                            <svg class="ls-ty-icon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                <path d="M20 7L10 17L4 11" stroke="currentColor" stroke-width="2.2"
                        ...
                        <div class="ls-ty-headings">
                            ...
                            <p class="ls-ty-subtitle mb-0">
                                We’ve got your listing request for <span
                                    class="ls-ty-highlight">{{ $listingName }}</span>.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="ls-ty-steps">
                            ...
                            <div class="ls-ty-step">
                                ...
                                <div class="ls-ty-step-text">
                                    ...
                                    <div class="ls-ty-step-desc">
                                        If approved, your listing goes live (usually within
                                        <strong>{{ $reviewDays }}</strong> business days).
                                    </div>
                                </div>
                            </div>
                        </div>
