    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-md-4">
                ...
                <p class="footer-small mb-2">
                    ...
                    rate your experience and grow your business online.
                </p>
            ...
            <div class="col-md-3">
                ...
                <a href="#" class="footer-link">Add Your Business</a>
                <a href="#" class="footer-link">Browse Categories</a>
            ...
            <div class="col-md-3">
                ...
                <p class="footer-small">
                    Subscribe to receive tips, updates and offers for small businesses.
                </p>
        ...
        <div class="footer-bottom d-flex flex-column flex-md-row justify-content-between align-items-center mt-4">
            <div class="footer-small">
                &copy; <span id="footerYear"></span> Online Market BD. All rights reserved.
            </div>
            <div class="footer-small mt-2 mt-md-0">
                <a href="#" class="footer-link d-inline-block me-2">Privacy Policy</a>
                <a href="#" class="footer-link d-inline-block">Terms of Use</a>
            </div>
        </div>
    </div>
</footer>