...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-1">Simple onboarding. Minimal details. Fast publish flow.</p>
        </div>

        <form action="{{ route('classifieds.ads.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-6">
            @csrf
            ...
            <div class="flex justify-end">
                <button type="submit" class="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-3 rounded-xl">
                    Submit Ad
                </button>
            </div>
        </form>
