...
@section('pages')
        ...
        <div class="container ">
            <header class="site-header">
                <nav class="navbar navbar-expand-md container p-0">
                    ...
                    <button class="navbar-toggler d-block d-md-none border-0  custom-hamburger" type="button"
                        data-bs-toggle="offcanvas" style="color: #ff7921" data-bs-target="#mainOffcanvas"
    ...
    <div class="wizard-wrapper">
        ...
        <form id="onboardingForm" class="wizard-card" enctype="multipart/form-data" method="POST"
            ...
            <div class="wizard-body">
                ...
                <div class="step-panel active" data-step="0">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('business_type_id') is-invalid @enderror" name="type"
                                id="businessTypeSelect" required>
                                <option value="">Select type</option>
                                @foreach ($categories as $typeCat)
                                    {{-- parent_id NULL categories --}}
                                    <option value="{{ $typeCat->id }}"
                                        {{ old('business_type_id') == $typeCat->id ? 'selected' : '' }}>
                                        {{ $typeCat->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('primary_category_id') is-invalid @enderror"
                                name="category_id" id="primaryCategorySelect"
                                data-children-url="{{ route('listings.category') }}"
                                data-old="{{ old('primary_category_id') }}" disabled>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('about') is-invalid @enderror" name="description" rows="4" required
                                placeholder="Tell customers what makes your business special...">{{ old('about') }}</textarea>
                            @error('about')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">This appears on your public listing page.</div>
                        </div>
                ...
                <div class="step-panel" data-step="1">
                    ...
                    <p class="form-section-help">We use this to show your listing in the correct city and help customers
                        contact you.</p>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('country') is-invalid @enderror" name="country" required>
                                ...
                                <option value="BD" {{ old('country', 'BD') === 'BD' ? 'selected' : '' }}>Bangladesh
                                </option>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('city') is-invalid @enderror" name="city"
                                value="{{ old('city') }}" required placeholder="Dhaka, Chattogram, etc.">
                            @error('city')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="address_line2"
                                value="{{ old('address_line2') }}" placeholder="Floor, landmark, suite #">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Fax</label>
                            <input type="text" class="form-control @error('fax') is-invalid @enderror" name="fax"
                                value="{{ old('fax') }}" placeholder="Optional">
                            @error('fax')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <label class="form-label mb-0">Other Emails</label>
                                <button type="button" class="btn btn-sm btn-outline-primary" id="addOtherEmail">
                                    <i class="fa-solid fa-plus me-1"></i> Add email
                                </button>
                            </div>
                            <div class="form-text mb-2">You can add multiple emails (support, billing, etc.).</div>

                            <div id="otherEmailsWrap" class="d-grid gap-2">
                                @php $oldOtherEmails = old('other_emails', []); @endphp

                                @if (!empty($oldOtherEmails))
                                    @foreach ($oldOtherEmails as $em)
                                        <div class="yp-repeater-row d-flex gap-2 align-items-center">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <label class="form-label mb-0">Other Phone Numbers</label>
                                <button type="button" class="btn btn-sm btn-outline-primary" id="addOtherPhone">
                                    <i class="fa-solid fa-plus me-1"></i> Add phone
                                </button>
                            </div>
                            <div class="form-text mb-2">Add hotline / service / branch numbers.</div>

                            <div id="otherPhonesWrap" class="d-grid gap-2">
                                @php $oldOtherPhones = old('other_phones', []); @endphp

                                @if (!empty($oldOtherPhones))
                                    @foreach ($oldOtherPhones as $ph)
                                        <div class="yp-repeater-row d-flex gap-2 align-items-center">
                                            <input type="text" name="other_phones[]" class="form-control"
                                                value="{{ $ph }}" placeholder="+8801xxxxxxxxx">
                                            <button type="button" class="btn btn-outline-danger btn-sm remove-row">
                                                <i class="fa-solid fa-trash"></i>
                                            </button>
                                        </div>
                ...
                <div class="step-panel" data-step="2">
                    ...
                    <p class="form-section-help">Basic details to show “Open Now / Closed Now” and some photos of your
                        place.</p>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('price_level') is-invalid @enderror" name="price_level">
                                ...
                                @foreach (['Low' => 'Low Level', 'Mid' => 'Mid Level', 'High Level' => 'High Level', 'Luxury' => 'Luxury Level'] as $val => $label)
                                    <option value="{{ $val }}"
                                        {{ old('price_level') == $val ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('price_level')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="servicesText"
                                placeholder="Type service and press Enter (e.g., Drain Cleaning)">
                            <div class="form-text">Press Enter to add. Will submit as services[].</div>

                            <div id="servicesChips" class="d-flex flex-wrap gap-2 mt-2"></div>
                            <div id="servicesHiddenWrap">
                                @foreach (old('services', []) as $srv)
                                    <input type="hidden" name="services[]" value="{{ $srv }}">
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <label class="form-label mb-0">Social Profiles</label>
                                <button type="button" class="btn btn-sm btn-outline-primary" id="addSocial">
                                    <i class="fa-solid fa-plus me-1"></i> Add profile
                                </button>
                            </div>

                            <div id="socialWrap" class="d-grid gap-2 mt-2">
                                @php $oldSocial = old('social_profiles', []); @endphp

                                @if (!empty($oldSocial))
                                    @foreach ($oldSocial as $idx => $row)
                                        <div class="yp-repeater-row">
                                            <div class="row g-2 align-items-center">
                                                <div class="col-12 col-md-4">
                                                    <select name="social_profiles[{{ $idx }}][platform]"
                                                        class="form-select">
                                                        <option value="">Select platform</option>
                                                        @foreach (['facebook', 'instagram', 'linkedin', 'youtube', 'x', 'tiktok'] as $p)
                                                            <option value="{{ $p }}"
                                                                {{ ($row['platform'] ?? '') === $p ? 'selected' : '' }}>
                                                                {{ ucfirst($p) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                ...
                                @else
                                    <div class="yp-repeater-row">
                                        <div class="row g-2 align-items-center">
                                            <div class="col-12 col-md-4">
                                                <select name="social_profiles[0][platform]" class="form-select">
                                                    <option value="">Select platform</option>
                                                    @foreach (['facebook', 'instagram', 'linkedin', 'youtube', 'x', 'tiktok'] as $p)
                                            ...
                                            <div class="col-12 col-md-7">
                                                <input type="url" name="social_profiles[0][url]" class="form-control"
                                                    placeholder="https://...">
                                            </div>
                                            <div class="col-12 col-md-1 d-grid">
                                                <button type="button" class="btn btn-outline-danger btn-sm remove-row">
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <div class="row g-2">
                                <div class="col-6 col-md-3">
                                    <select class="form-select @error('opens_at') is-invalid @enderror" name="opens_at">
                                        ...
                                        @foreach ($timeOptions as $val => $label)
                                            <option value="{{ $val }}"
                                                {{ old('opens_at') === $val ? 'selected' : '' }}>{{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('opens_at')
                                ...
                                <div class="col-6 col-md-3">
                                    <select class="form-select @error('closes_at') is-invalid @enderror"
                                        name="closes_at">
                                        <option value="">Closes at</option>
                                        @foreach ($timeOptions as $val => $label)
                                            <option value="{{ $val }}"
                                                {{ old('closes_at') === $val ? 'selected' : '' }}>{{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('closes_at')
                                ...
                                <div class="col-12 col-md-6">
                                    <select class="form-select @error('open_days') is-invalid @enderror"
                                        name="open_days">
                                        <option value="">Select days</option>
                                        @foreach (['Everyday', 'Mon – Fri', 'Fri – Sat', 'Custom (we’ll contact you)'] as $days)
                                            <option value="{{ $days }}"
                                                {{ old('open_days') === $days ? 'selected' : '' }}>{{ $days }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('open_days')
                            ...
                            <div class="form-text">
                                Times shown in <strong>Bangladesh Standard Time (Asia/Dhaka)</strong>. You can set exact
                                per-day hours after approval.
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <div class="border rounded border-dashed p-3 bg-light">
                                <input type="file" class="form-control @error('photos.*') is-invalid @enderror"
                                    name="photos[]" id="photosInput" accept="image/*" multiple>
                                @error('photos.*')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="upload-hint mt-1">
                                    Upload up to 6 clear photos of your business (front view, interior, products, etc.). JPG
                                    or PNG, max 3 MB each.
                                </div>
                ...
                <div class="step-panel" data-step="3">
                    ...
                    <p class="form-section-help">To protect customers and prevent fake listings, we require a valid NID and
                        at least one legal business document.</p>

                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Owner’s Full Name (As per NID) <span
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Upload NID (Front) <span
                                    class="text-danger">(Optional)</span></label>
                            <div class="border rounded border-dashed p-3 bg-light">
                        ...
                        <div class="col-12">
                            <div class="form-check mt-2">
                                ...
                                <label class="form-check-label" for="agreeTerms">
                                    I confirm that the information and documents provided are accurate and I am authorized
                                    to list this business.
                                </label>
                                @error('agreed_terms')
    ...
    <script>
        (function() {
            ...
            function initChipInput(textInputId, chipsWrapId, hiddenWrapId, hiddenName) {
                const input = document.getElementById(textInputId);
                const chipsWrap = document.getElementById(chipsWrapId);
                const hiddenWrap = document.getElementById(hiddenWrapId);
                if (!input || !chipsWrap || !hiddenWrap) return;

                let items = Array.from(hiddenWrap.querySelectorAll(`input[name="${hiddenName}"]`))
                ...
                function render() {
                    ...
                    items.forEach((item, idx) => {
                        ...
                        chip.className =
                            'badge text-bg-primary-subtle text-primary border border-primary-subtle';
                        chip.style.padding = '8px 10px';
                        chip.innerHTML =
                            `${escapeHtml(item)} <button type="button" class="btn btn-sm p-0 ms-2" data-i="${idx}" style="line-height:1;color:#1d4ed8;"><i class="fa-solid fa-xmark"></i></button>`;
            ...
            // Activate chips
            initChipInput('servicesText', 'servicesChips', 'servicesHiddenWrap', 'services[]');


            // Repeaters: add/remove
            document.addEventListener('click', function(e) {
                if (e.target.closest('.remove-row')) {
                    const row = e.target.closest('.yp-repeater-row');
                    if (row) row.remove();
                    reindexSocial();
                }
            });

            document.getElementById('addOtherEmail')?.addEventListener('click', function() {
                document.getElementById('otherEmailsWrap')?.insertAdjacentHTML('beforeend', `
    <div class="yp-repeater-row d-flex gap-2 align-items-center">
      <input type="email" name="other_emails[]" class="form-control" placeholder="example@domain.com">
      <button type="button" class="btn btn-outline-danger btn-sm remove-row"><i class="fa-solid fa-trash"></i></button>
    </div>
  `);
            });

            document.getElementById('addOtherPhone')?.addEventListener('click', function() {
                document.getElementById('otherPhonesWrap')?.insertAdjacentHTML('beforeend', `
    <div class="yp-repeater-row d-flex gap-2 align-items-center">
      <input type="text" name="other_phones[]" class="form-control" placeholder="+8801xxxxxxxxx">
      <button type="button" class="btn btn-outline-danger btn-sm remove-row"><i class="fa-solid fa-trash"></i></button>
    </div>
  `);
            });
            ...
            document.getElementById('addSocial')?.addEventListener('click', function() {
                ...
                const idx = wrap ? wrap.querySelectorAll('.yp-repeater-row').length : 0;
                wrap?.insertAdjacentHTML('beforeend', `
    <div class="yp-repeater-row">
      <div class="row g-2 align-items-center">
        <div class="col-12 col-md-4">
          <select name="social_profiles[${idx}][platform]" class="form-select">
            <option value="">Select platform</option>
        ...
        <div class="col-12 col-md-7">
          <input type="url" name="social_profiles[${idx}][url]" class="form-control" placeholder="https://...">
        </div>
        <div class="col-12 col-md-1 d-grid">
          <button type="button" class="btn btn-outline-danger btn-sm remove-row"><i class="fa-solid fa-trash"></i></button>
        </div>
  ...
  `);
            ...
            function reindexSocial() {
                const rows = document.querySelectorAll('#socialWrap .yp-repeater-row');
                rows.forEach((row, idx) => {
                    const sel = row.querySelector('select');
                    const inp = row.querySelector('input[type="url"]');
                    if (sel) sel.name = `social_profiles[${idx}][platform]`;
                    if (inp) inp.name = `social_profiles[${idx}][url]`;
                });
            }
