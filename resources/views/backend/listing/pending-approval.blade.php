                        ...
                        <div class="row g-2 align-items-end">
                            <div class="col-lg-4">
                                ...
                                <input name="q" value="{{ request('q') }}" class="form-control"
                                    placeholder="Listing name / owner / phone / tracking">
                            </div>
                            ...
                            <div class="col-lg-3">
                                ...
                                <select name="category_id" class="form-select">
                                    ...
                                    @foreach ($categories as $c)
                                        <option value="{{ $c->id }}"
                                            {{ (string) request('category_id') === (string) $c->id ? 'selected' : '' }}>
                                            {{ $c->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <tbody>
                                @forelse($listings as $i => $listing)
                                    @php
                                        ...
                                        $thumb = $listing->primaryPhoto?->path
                                            ? asset('storage/' . $listing->primaryPhoto->path)
                                            : null;
                                    @endphp
                                        ...
                                        <td class="fw-semibold">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="small text-muted">Tracking:
                                                        {{ $listing->tracking_id ?? '—' }}</div>
                                                </div>
                                            </div>
                                        </td>
