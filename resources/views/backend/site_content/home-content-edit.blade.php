        ...
        <div class="container-fluid py-2">
            ...
            @if ($errors->any())
                <div class="alert alert-danger">
                    <div class="fw-semibold mb-1"><i class="bi bi-exclamation-triangle-fill me-1"></i>Please fix the errors
                        below:</div>
                    <ul class="mb-0 small">
            ...
            <form id="homeContentForm" action="{{ route('home_content.update') }}" method="POST"
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text"
                                            ...
                                            name="about_title" value="{{ old('about_title', $content->about_title) }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('about_body') is-invalid @enderror" name="about_body" rows="5"
                                            placeholder="Write about your platform...">{{ old('about_body', $content->about_body) }}</textarea>
                                        @error('about_body')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="form-text">Tip: Keep it short and readable (2–4 lines per paragraph).
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text"
                                            ...
                                            name="manage_title" value="{{ old('manage_title', $content->manage_title) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            name="manage_phone" value="{{ old('manage_phone', $content->manage_phone) }}"
                                    ...
                                    <div class="col-12">
                                        <label class="form-label small">Description</label>
                                        <textarea class="form-control @error('manage_body') is-invalid @enderror" name="manage_body" rows="4"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="file"
                                            class="form-control @error('manage_image') is-invalid @enderror"
                                            name="manage_image" accept="image/png,image/jpeg,image/webp"
                                            data-preview="#previewManage">
                                        @error('manage_image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="file"
                                            ...
                                            name="mission_image" accept="image/png,image/jpeg,image/webp"
                                    ...
                                    <div class="col-12">
                                        <label class="form-label small">Description</label>
                                        <textarea class="form-control @error('mission_body') is-invalid @enderror" name="mission_body" rows="4"
                                ...
                                <div class="row g-3">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text"
                                            ...
                                            name="vision_title" value="{{ old('vision_title', $content->vision_title) }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="file"
                                            ...
                                            name="vision_image" accept="image/png,image/jpeg,image/webp"
                                    ...
                                    <div class="col-12">
                                        <label class="form-label small">Description</label>
                                        <textarea class="form-control @error('vision_body') is-invalid @enderror" name="vision_body" rows="4"
                            ...
                            <div class="card-body">
                                ...
                                <div class="small text-muted">
                                    <div class="mb-2 d-flex gap-2">
                                        ...
                                        <div><span class="fw-semibold text-dark">Keep it short:</span> users scan quickly.
                                        </div>
                                    </div>
                                    <div class="mb-2 d-flex gap-2">
                                        <span class="text-primary"><i class="bi bi-image"></i></span>
                                        <div><span class="fw-semibold text-dark">Use WEBP:</span> smaller + faster loading.
                                        </div>
                                    </div>
                                    <div class="mb-2 d-flex gap-2">
                                        <span class="text-primary"><i class="bi bi-link-45deg"></i></span>
                                        <div><span class="fw-semibold text-dark">CTA URL:</span> use a route like
                                            <code>/claim</code> or full URL.</div>
                                    </div>
                                    <div class="mb-2 d-flex gap-2">
                                        <span class="text-primary"><i class="bi bi-check2-square"></i></span>
                                        <div><span class="fw-semibold text-dark">Preview after save</span> to confirm
                                            spacing & cropping.</div>
                                    </div>
                                </div>
