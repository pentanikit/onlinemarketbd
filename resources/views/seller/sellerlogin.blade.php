...
<head>
    ...
    <title>Online Market BD . Seller Login</title>
                    ...
                    <form method="POST" action="{{ route('login.submit') }}" class="sa-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}"
                                class="form-control sa-input" placeholder="seller@email.com" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label sa-label">Password</label>
                            <input type="password" name="password" class="form-control sa-input" placeholder="••••••••"
                                required>
                        </div>
